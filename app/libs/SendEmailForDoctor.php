    ...
    class SendEmailForDoctor {
        ...
        function SendEmail($email, $fullName, $password) {
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = "[Account Confirmation for ExtraClinic]";
                $mail->Body = "
                    <!DOCTYPE html>
                    <html lang='en'>
                    <head>
                    ...
                    <body>
                        <div class='email-content'>
                            ...
                            <div class='email-body'>
                                ...
                                <p>We are excited to have you join us as a new doctor at ExtraClinic.</p>
                                <p>Here are your account details:</p>
                                <ul>
                                    <li><strong>Email:</strong> $email</li>
                                    <li><strong>Password:</strong> $password</li>
                                </ul>
                                <p>Please use these credentials to log in and start exploring our system.</p>
